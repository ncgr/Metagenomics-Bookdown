...
\hypertarget{metagenomics-and-metatranscriptomics}{%
\section{Metagenomics and Metatranscriptomics}\label{metagenomics-and-metatranscriptomics}}

\textbf{Metagenomics:} Untargeted sequencing of all microbial genomes present in a sample.

\hypertarget{shotgun-metagenomics}{%
\subsection{Shotgun Metagenomics}\label{shotgun-metagenomics}}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./Figures/MetaWorkflow.png}
\caption{Quince, C., Walker, A. W., Simpson, J. T., Loman, N. J., \& Segata, N. (2017). Shotgun metagenomics, from sampling to analysis. Nature biotechnology, 35(9), 833-844.}
\end{figure}

\hypertarget{sample-collection-and-dna-extraction}{%
\subsection{Sample collection and DNA extraction}\label{sample-collection-and-dna-extraction}}
...
\hypertarget{sources-of-contamination}{%
\subsection{Sources of contamination}\label{sources-of-contamination}}
...
\hypertarget{coverage-and-sequencing-considerations}{%
\subsection{Coverage and Sequencing considerations}\label{coverage-and-sequencing-considerations}}
...
\hypertarget{illumina-sequencers-and-yield}{%
\subsection{Illumina Sequencers and Yield}\label{illumina-sequencers-and-yield}}

\url{https://www.illumina.com/systems/sequencing-platforms.html}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./Figures/Illumiinaseq.png}
\caption{Quince, C., Walker, A. W., Simpson, J. T., Loman, N. J., \& Segata, N. (2017). Shotgun metagenomics, from sampling to analysis. Nature biotechnology, 35(9), 833-844.}
\end{figure}

\hypertarget{generalized-workflow-of-metagenomic-next-generation-sequencing-for-diagnostic-clinical-use}{%
\subsection{Generalized workflow of metagenomic next-generation sequencing for diagnostic clinical use}\label{generalized-workflow-of-metagenomic-next-generation-sequencing-for-diagnostic-clinical-use}}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./Figures/WetDry.png}
\caption{Gu, W., Miller, S., \& Chiu, C. Y. (2019). Clinical metagenomic next-generation sequencing for pathogen detection. Annual Review of Pathology: Mechanisms of Disease, 14, 319-338.}
\end{figure}

\hypertarget{generic-analysis-workflow}{%
\subsection{Generic Analysis Workflow}\label{generic-analysis-workflow}}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./Figures/GenericWkflw.png}
\caption{Oulas, A., Pavloudi, C., Polymenakou, P., Pavlopoulos, G. A., Papanikolaou, N., Kotoulas, G., \ldots{} \& Iliopoulos, L. (2015). Metagenomics: tools and insights for analyzing next-generation sequencing data derived from biodiversity studies. Bioinformatics and biology insights, 9, BBI-S12462.}
\end{figure}

\hypertarget{strengths-and-weaknesses-of-assembly-based-and-read-based-metagenomics-analysis}{%
\subsection{Strengths and weaknesses of assembly-based and read-based metagenomics analysis}\label{strengths-and-weaknesses-of-assembly-based-and-read-based-metagenomics-analysis}}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./Figures/AssemblyvsRead.png}
\caption{Quince, C., Walker, A. W., Simpson, J. T., Loman, N. J., \& Segata, N. (2017). Shotgun metagenomics, from sampling to analysis. Nature biotechnology, 35(9), 833-844.}
\end{figure}

\hypertarget{tools-and-web-servers-related-to-gut-microbiome-studies.}{%
\subsection{Tools and web servers related to gut microbiome studies.}\label{tools-and-web-servers-related-to-gut-microbiome-studies.}}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./Figures/Toolsandweb.png}
\caption{Malla, M. A., Dubey, A., Kumar, A., Yadav, S., Hashem, A., \& Abd\_Allah, E. F. (2019). Exploring the human microbiome: the potential future role of next-generation sequencing in disease diagnosis and treatment. Frontiers in Immunology, 9, 2868.}
\end{figure}

\hypertarget{benefits-and-limitations-of-whole-genome-metagenomics}{%
\subsection{Benefits and limitations of whole genome metagenomics}\label{benefits-and-limitations-of-whole-genome-metagenomics}}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=\textheight]{./Figures/Frag.png}
\caption{Malla, M. A., Dubey, A., Kumar, A., Yadav, S., Hashem, A., \& Abd\_Allah, E. F. (2019). Exploring the human microbiome: the potential future role of next-generation sequencing in disease diagnosis and treatment. Frontiers in Immunology, 9, 2868.}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./Figures/HumanMicrobiome.png}
\caption{Bikel, S., Valdez-Lara, A., Cornejo-Granados, F., Rico, K., Canizales-Quinteros, S., Soberón, X., \ldots{} \& Ochoa-Leyva, A. (2015). Combining metagenomics, metatranscriptomics and viromics to explore novel microbial interactions: towards a systems-level understanding of human microbiome. Computational and structural biotechnology journal, 13, 390-401.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./Figures/NCGRMeta.png}
\caption{NCGR}
\end{figure}

\hypertarget{benefits-of-metatranscriptomics}{%
\subsection{Benefits of Metatranscriptomics}\label{benefits-of-metatranscriptomics}}

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./Figures/BenefitsMeta.png}
\caption{NCGR}
\end{figure}
...
\url{https://www.youtube.com/watch?v=azI9taClDhQ}
...
\FunctionTok{ls}\KeywordTok{|} \FunctionTok{wc} \AttributeTok{{-}l}
...
\ControlFlowTok{for}\NormalTok{ file }\KeywordTok{in} \PreprocessorTok{*}\NormalTok{.gz}\KeywordTok{;} \ControlFlowTok{do} \ExtensionTok{fastp} \AttributeTok{{-}i} \VariableTok{$\{file\}} \AttributeTok{{-}o} \VariableTok{$\{file\}}\NormalTok{.filtered}\KeywordTok{;} \ControlFlowTok{done}
\ExtensionTok{conda}\NormalTok{ deactivate}
\end{Highlighting}
\end{Shaded}

\includegraphics[width=1\textwidth,height=\textheight]{./QIIMEpics/lyx.qiime.table.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{qiime}\NormalTok{ feature{-}table merge{-}seqs }\AttributeTok{{-}{-}i{-}data}\NormalTok{ rep{-}seqs{-}or{-}99.qza }\DataTypeTok{\textbackslash{}}
\NormalTok{new{-}ref{-}seqs{-}or{-}99.qza }\AttributeTok{{-}{-}o{-}merged{-}data}\NormalTok{ all{-}or{-}seqs{-}99.qza}
\end{Highlighting}
\end{Shaded}

\hypertarget{building-a-phylogenetic-tree}{%
\section{Building a phylogenetic tree}\label{building-a-phylogenetic-tree}}
...
\NormalTok{{-}{-}i{-}sequences all{-}or{-}seqs{-}99.qza }\DataTypeTok{\textbackslash{}}
...
\hypertarget{alpha-rarefaction}{%
\section{Alpha rarefaction}\label{alpha-rarefaction}}
...
\hypertarget{calculating-and-exploring-diversity-metrics}{%
\section{Calculating and exploring diversity metrics}\label{calculating-and-exploring-diversity-metrics}}
...
\NormalTok{{-}{-}i{-}reads all{-}or{-}seqs{-}99.qza }\DataTypeTok{\textbackslash{}}
...
\hypertarget{diversity-visualization}{%
\section{Diversity Visualization}\label{diversity-visualization}}
...
\hypertarget{differential-abundance---ancom---analysis-of-composition-of-microbes-optional}{%
\section{Differential Abundance - ANCOM - Analysis of Composition of Microbes (Optional)}\label{differential-abundance---ancom---analysis-of-composition-of-microbes-optional}}
...
EXERCISE: Preparing your raw sequence data and importing. This material closely follows the tutorial available at \url{https://docs.qiime2.org/2021.2/tutorials/atacama-soils/}
...
\FunctionTok{wget}\NormalTok{ https://data.qiime2.org/2021.2/tutorials/atacama{-}soils/10p/forward.fastq.gz}

\FunctionTok{wget}\NormalTok{ https://data.qiime2.org/2021.2/tutorials/atacama{-}soils/10p/reverse.fastq.gz}

\FunctionTok{wget}\NormalTok{ https://data.qiime2.org/2021.2/tutorials/atacama{-}soils/10p/barcodes.fastq.gz}
...
\NormalTok{{-}{-}i{-}demultiplexed{-}seqs demux.qza }\DataTypeTok{\textbackslash{}}
\NormalTok{{-}{-}p{-}trim{-}left{-}f 13 }\DataTypeTok{\textbackslash{}}
...
The above step takes \textasciitilde{} 10 minutes.
