...
![KrakenUniq Overview](./Figures/KrakenUniq.png){width=80%}
...
(or if you have installed it locally through Rstudio and prefer to access it that way, open Rstudio and type "pavian::runApp(port=5000)" in the console)
