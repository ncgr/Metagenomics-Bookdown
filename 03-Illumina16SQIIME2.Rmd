# Illumina 16S Community Profiling (QIIME2)
...
The paper is here:  
https://pubmed.ncbi.nlm.nih.gov/30298251/


Before we jump into QIIME2, we need need to cover a few terms that you will encounter in QIIME2 analysis.
...
Create a directory for the QIIME2 analysis.
...
![tuberculosis](./QIIMEpics/lyx.qiime.png){width=60%}
...
fastp is a tool that can quickly do both pre-processing and quality control on short sequence reads (FASTQ files). A corresponding tool, fastplong, is available for long reads.

https://github.com/OpenGene/fastp

Use the default parameters to filter poor quality reads
...
Metadata file that we will be using for our data set: (mappingFile.txt on Ghostwheel)
...
cd /home/<username>/QIIME2_Analysis

cp /home/data/metagenomics/mappingFile.txt .
...
cp /home/data/metagenomics/seqs.1000.fna .

conda deactivate

conda activate qiime2

# This command will vary depending on input data type and format
...
# EXAMPLE- DO NOT RUN THE BELOW COMMAND
...
cp /home/data/metagenomics/99_otus.qza .
...
cp /home/data/metagenomics/table-or-99.qza .
cp /home/data/metagenomics/rep-seqs-or-99.qza .
cp /home/data/metagenomics/new-ref-seqs-or-99.qza .
...
![workflow](./QIIMEpics/forlyx.trees.qiime.png){width=50%}
...
cp /home/data/metagenomics/aligned-rep-seqs.qza .
...
cp /home/data/metagenomics/unrooted-tree.qza .
...
### Population Diversity: **alpha and beta diversity**
...
# EXAMPLE- DO NOT RUN THE FOLLOWING COMMAND TO COMPLETION
...
scp -P 2508 <username>@inbre.ncgr.org:~/QIIME2_Analysis/core-metrics-results ~/Desktop/
...
cp /home/data/metagenomics/taxonomy.qza .
...
scp -P2508 <username>@inbre.ncgr.org:/home/<username>/QIIME2_Analysis\
...
cp /home/data/metagenomics/nasal-table.qza .
=================================================
...
cp /home/data/metagenomics/ancom-Treatment-nasal.qzv .
```
