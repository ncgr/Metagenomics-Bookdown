...
Or copy it from here: /home/data/metagenomics/squeezemeta/SraRunTable.txt

<!--I created an SraRunTable that only has the 6 samples we are using-->
...
reads aligned to the assembly so we are losing a lot (likely the low abundance organisms). The bottom command uses the sqm_read.pl script to perform a read-based method for
...
mkdir ~/squeezemeta/fastq
cd ~/squeezemeta/fastq
ln -s /home/data/metagenomics/squeezemeta/*.fastq .
...
-f ~/squeezemeta/fastq -a megahit -map minimap2-sr
...
ln -s /home/data/metagenomics/squeezemeta/gingivitis_2 ~/squeezemeta/
